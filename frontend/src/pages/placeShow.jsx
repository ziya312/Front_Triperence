...
function PlaceShow() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        const responseOne = await axios.get(`http://localhost:8080/survey/result/type=choa`);
        const responseTwo = await axios.get(`http://localhost:8080/survey/result/type=himchan`);
